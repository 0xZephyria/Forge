...
Welcome to **Forge**, the natively-compiled, highly-parallel, and intensely secure smart contract language built exclusively for Forgeyria Network. 
...
Before writing a line of Forge, it is critical to understand the architecture of the Zephyria Network.
