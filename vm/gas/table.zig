...
pub const SyscallGas = struct {
    ...
    // ── Oracle ──
    pub const ORACLE_QUERY: u64 = 500;

    // ── Cryptography (ZK) ──
    pub const ZK_VERIFY: u64 = 45_000;

    // ── Gas / Account operations ──
    pub const DELEGATE_GAS: u64 = 200;
    pub const EXPAND_ACCOUNT: u64 = 5_000;
    pub const CLOSE_ACCOUNT: u64 = 5_000;
